...
public class RequestUtil {
    ...
    public static ResponseEntity doPost(HttpServletRequest request,Map<String,Object> params,RestTemplate restTemplate){
        ...
        try {
            ...
            ErrorLogUtils.requestSuccessLog(getRealIp(request),"POST",url,params,responseEntity);
        }catch (Exception e){
            responseEntity = ResponseUtils.getResponseFromException(e);
            ErrorLogUtils.requestErrorLog(getRealIp(request),"POST",url,params,responseEntity);
        }
        return responseEntity;
    }
