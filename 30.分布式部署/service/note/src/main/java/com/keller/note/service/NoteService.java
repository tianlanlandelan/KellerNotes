...
import com.keller.note.mapper.NoteMapper;
...
public class NoteService {
    ...
    public ResultData del(int userId,int noteId){
        ...
        Integer result = mapper.baseDeleteById(noteInfo);

        // 从文件服务器中删除笔记中的图片
        if(result == 1){
            FileUtils.deleteImgByNoteId(userId,noteId);
        }
     ...
     * @return
     */
    public ResultData delImg(int userId,String imgName){
        FileUtils.deleteImg(imgName,userId);
        return ResultData.success();
    }
